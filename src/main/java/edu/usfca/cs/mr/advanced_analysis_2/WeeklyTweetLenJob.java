 ...
 */
public class WeeklyTweetLenJob {
    public static void main(String[] args) {
        try {
            ...
            Job job1 = Job.getInstance(conf, "Weekly tweet sentiment with lenght (0,150),(150,200),(200,250)");
            ...
            /* Current class */
            job1.setJarByClass(WeeklyTweetLenJob.class);

            /* Mapper class */
            job1.setMapperClass(WeeklyTweetLenMapper.class);

            /* Reducer class */
            job1.setReducerClass(WeeklyTweetLenReducer.class);

            /* Outputs from the Mapper. */
            job1.setMapOutputKeyClass(IntWritable.class);
            job1.setMapOutputValueClass(WeeklyTweetLenWritable.class);

            /* Outputs from the Reducer */
            job1.setOutputKeyClass(Text.class);
            job1.setOutputValueClass(WeeklyTweetLenWritable.class);
