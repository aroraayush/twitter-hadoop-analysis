 ...
 */
public class WeeklyHashtagCountJob {
    public static void main(String[] args) {
        try {
            ...
            Job job = Job.getInstance(conf, "Weekly Hashtags Job");
            ...
            /* Current class */
            job.setJarByClass(WeeklyHashtagCountJob.class);
...
//            job.setCombinerClass(TagCountReducer.class);
            ...
            job.setMapOutputValueClass(WeekWritable.class);

            /* Outputs from the Reducer */
            job.setOutputKeyClass(Text.class);
            job.setOutputValueClass(WeekWritable.class);
